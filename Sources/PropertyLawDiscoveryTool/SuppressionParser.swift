...
/// `// property-law-suppress: <protocol>_<TypeName>` markers and returns the
...
enum SuppressionParser {
    ...
    static func parse(text: String) -> Set<String> {
        // Match `// property-law-suppress: <key>` lines. Keys are
        ...
        for rawLine in text.split(whereSeparator: \.isNewline) {
            ...
            guard line.hasPrefix("// property-law-suppress:") else { continue }
            let key = line
                .dropFirst("// property-law-suppress:".count)
