...
/// violations on floating-point inputs. Use `checkFloatingPointProtocolLaws`
/// (v1.4 M4) for IEEE-754 types instead.
@discardableResult
public func checkNumericProtocolLaws<
...
>(
    ...
    do {
        return try await checkAdditiveArithmeticProtocolLaws(
            for: type,
            using: generator,
